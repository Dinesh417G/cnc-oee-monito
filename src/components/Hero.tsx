  ...
  return (
    ...
    <section className="relative overflow-hidden border-b border-line bg-gradient-to-b from-white to-[#f4f6fb] pt-20">
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 md:px-10">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1.05fr_.95fr] lg:gap-14">
        ...
        <div className="flex flex-nowrap gap-2.5 overflow-x-auto scrollbar-hide border-t border-line py-4">
          {[
